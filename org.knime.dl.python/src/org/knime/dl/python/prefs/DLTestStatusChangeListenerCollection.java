 ...
 */
class DLTestStatusChangeListenerCollection {

    private CopyOnWriteArrayList<DLPythonConfigsInstallationTestStatusChangeListener> m_listeners =
    ...
    protected synchronized void onCondaInstallationTestStarting() {
        for (final DLPythonConfigsInstallationTestStatusChangeListener listener : m_listeners) {
     ...
     * @param library The DL library the environment is for
     */
    protected synchronized void onEnvironmentInstallationTestStarting(final PythonEnvironmentType environmentType,
        ...
        for (final DLPythonConfigsInstallationTestStatusChangeListener listener : m_listeners) {
            listener.environmentInstallationTestStarting(environmentType, library);
        }
    }
    ...
    protected synchronized void onEnvironmentInstallationTestFinished(final PythonEnvironmentType environmentType,
        ...
        for (final DLPythonConfigsInstallationTestStatusChangeListener listener : m_listeners) {
            listener.environmentInstallationTestFinished(environmentType, library, testResult);
        }
    }
     ...
     */
    public boolean removeConfigsTestStatusListener(final DLPythonConfigsInstallationTestStatusChangeListener listener) {
     ...
     * class.
     */
    public static interface DLPythonConfigsInstallationTestStatusChangeListener {
        ...
        void environmentInstallationTestStarting(PythonEnvironmentType environmentType,
            DLPythonLibrarySelection library);
        ...
        void environmentInstallationTestFinished(PythonEnvironmentType environmentType,
            DLPythonLibrarySelection library, PythonKernelTestResult testResult);
    }
}
