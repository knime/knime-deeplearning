 ...
 */
public class DLPythonByteBufferSerializerFactory extends SerializerFactory<DLPythonByteBuffer>
    implements DLSerializerFactory {

    /**
     * The unique identifier of this serializer factory.
     */
    public static final String IDENTIFIER = "org.knime.dl.python.core.data.serde.DLPythonByteBufferSerializerFactory";

    /**
     * Empty framework constructor.
     */
    public DLPythonByteBufferSerializerFactory() {
        super(DLPythonByteBuffer.class);
    }
