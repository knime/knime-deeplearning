...
public class DLPythonShortBuffer extends DLPythonAbstractDataBuffer<DLDefaultShortBuffer, short[]>
    implements DLWritableShortBuffer, DLReadableShortBuffer {

    /**
     * This buffer's {@link DataType}.
     */
    public static final DataType TYPE = DataType.getType(DLPythonShortBuffer.class);
     ...
     */
    public DLPythonShortBuffer(final long capacity) {
        super(new DLDefaultShortBuffer(capacity));
    }
