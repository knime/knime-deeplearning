...
public abstract class DLPythonObjectBuffer<T, B extends DLAbstractObjectBuffer<T>>
    extends DLPythonAbstractDataBuffer<B, T[]> implements DLWritableObjectBuffer<T>, DLReadableObjectBuffer<T> {

    /**
     * @param buffer the wrapped buffer
     */
    protected DLPythonObjectBuffer(final B buffer) {
        super(buffer);
    }

    @Override
    public T readNext() {
        return m_buffer.readNext();
    }
