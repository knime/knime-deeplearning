 ...
 */
public class DLPythonLongBufferSerializerFactory extends SerializerFactory<DLPythonLongBuffer>
    implements DLSerializerFactory {

    /**
     * The unique identifier of this serializer factory.
     */
    public static final String IDENTIFIER = "org.knime.dl.python.core.data.serde.DLPythonLongBufferSerializerFactory";

    /**
     * Empty framework constructor.
     */
    public DLPythonLongBufferSerializerFactory() {
    ...
    public Serializer<? extends DLPythonLongBuffer> createSerializer() {
        ...
        return new Serializer<DLPythonLongBuffer>() {

            @Override
            public byte[] serialize(final DLPythonLongBuffer value) throws IOException {
                ...
                final long numBytes = /* Integer.BYTES + numDimensions * Long.BYTES + */ size * Long.BYTES;
                if (numBytes > Integer.MAX_VALUE) {
                    throw new IOException("Transmitting data to Python failed. Buffer size exceeds the limit of "
                        + Integer.MAX_VALUE + "bytes.");
                }
                final LongBuffer longBuffer = LongBuffer.wrap(value.getStorage());
