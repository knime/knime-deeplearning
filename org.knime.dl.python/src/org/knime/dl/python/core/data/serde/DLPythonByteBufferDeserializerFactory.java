 ...
 */
public class DLPythonByteBufferDeserializerFactory extends DeserializerFactory implements DLPythonDeserializerFactory {

    /**
     * The unique identifier of this deserializer factory.
     */
    public static final String IDENTIFIER = "org.knime.dl.python.core.data.serde.DLPythonByteBufferDeserializerFactory";

    /**
     * Empty framework constructor.
     */
    public DLPythonByteBufferDeserializerFactory() {
        super(DLPythonByteBuffer.TYPE);
    }
     ...
     */
    @Override
    public Class<? extends DLPythonByteBuffer> getBufferType() {
        return DLPythonByteBuffer.class;
    }
}
