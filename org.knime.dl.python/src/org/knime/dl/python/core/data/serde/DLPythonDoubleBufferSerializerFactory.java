...
public class DLPythonDoubleBufferSerializerFactory extends SerializerFactory<DLPythonDoubleBuffer>
	 ...
	 */
	public static final String IDENTIFIER = "org.knime.dl.python.core.data.serde.DLPythonDoubleBufferSerializerFactory";

	/**
	 * Empty framework constructor.
	 */
	public DLPythonDoubleBufferSerializerFactory() {
	...
	public Serializer<? extends DLPythonDoubleBuffer> createSerializer() {
		...
		return new Serializer<DLPythonDoubleBuffer>() {
			...
			public byte[] serialize(final DLPythonDoubleBuffer value) throws IOException {
				...
				final DoubleBuffer doubleBuffer = DoubleBuffer.wrap(value.getStorage());
