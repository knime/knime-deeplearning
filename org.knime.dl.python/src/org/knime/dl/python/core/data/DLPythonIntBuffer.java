...
public class DLPythonIntBuffer extends AbstractDLPythonDataDataBuffer<int[]>
    implements DLWritableIntBuffer, DLReadableIntBuffer {

    public static final DataType TYPE = DataType.getType(DLPythonIntBuffer.class);
     ...
     */
    @Override
    public void putStorage(final int[] storage) {
    ...
    protected boolean equalsDataCell(final DataCell dc) {
        return Arrays.equals(m_storage, ((DLPythonIntBuffer)dc).m_storage);
    }
