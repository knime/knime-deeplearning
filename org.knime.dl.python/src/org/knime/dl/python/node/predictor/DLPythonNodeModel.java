 ...
 * 
 * @author Christian Dietz, KNIME.com
 *
 * @param <Config>
 */
abstract class DLPythonNodeModel<Config extends PythonSourceCodeConfig> extends ExtToolOutputNodeModel {
	
	Config m_config = createConfig();
    
	public DLPythonNodeModel(final PortType[] inPortTypes,
