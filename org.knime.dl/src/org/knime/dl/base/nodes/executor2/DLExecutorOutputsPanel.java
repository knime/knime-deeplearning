...
final class DLExecutorOutputsPanel {
     ...
     *
     */
    public DLExecutorOutputsPanel(final DLExecutorGeneralConfig generalCfg, final JPanel dialogPanel,
    ...
    private void addAction(final DLExecutorGeneralConfig generalCfg, final JPanel dialogPanel) {
        ...
        final int selectedOption = JOptionPane.showConfirmDialog(dialogPanel, outputsAddDlg, "Add output...",
        ...
        if (selectedOption == JOptionPane.OK_OPTION) {
            ...
            if (!DLUtils.Shapes.isKnown(outputTensorSpec.getShape())) {
                final String msg =
                    "Output '" + outputTensorSpec.getName() + "' has an unknown shape. This is not supported.";
                LOGGER.error(msg);
    ...
    private void fillAvailableOutputs(final DLNetworkSpec networkSpec, final ArrayList<String> availableOutputs,
        ...
        final HashMap<String, String> availableOutputsSuffixMap) {
        ...
        for (int i = networkSpec.getHiddenOutputSpecs().length - 1; i >= 0; i--) {
            ...
            addToAvailableOutputs(availableOutputs, availableOutputsMap, availableOutputsSuffixMap, intermediateSpec,
                HIDDEN_SUFFIX);
        }
    }
