...
public class DefaultConfigEntry<T> extends AbstractStandardConfigEntry<T> {
	...
	public DefaultConfigEntry(final String entryKey, final Class<T> entryType, final T value) {
		super(entryKey, entryType, value);
	}

	public DefaultConfigEntry(final String entryKey, final Class<T> entryType, final T value, final boolean enabled) {
