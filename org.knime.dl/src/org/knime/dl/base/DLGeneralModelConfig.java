...
/**
 * Note: all those config classes will certainly be generalized and extended in
 * the future as they're probably viable tools for saving/loading across all dl
 * nodes. (e.g., they could implement a common super interface
 * 'DLNodeModelConfig' etc.)
 *
 * @author Marcel Wiedenmann, KNIME, Konstanz, Germany
 * @author Christian Dietz, KNIME, Konstanz, Germany
 */
public class DLGeneralModelConfig {
	...
	private static final String CFG_KEY_APPEND = "append_columns";
	...
	public DLGeneralModelConfig(final String defaultBackend, final int defaultBatchSize) {
		m_appendColumns = new SettingsModelBoolean(CFG_KEY_APPEND, false);
	...
	public SettingsModelBoolean getAppendColumns() {
	...
	public void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
		...
		m_appendColumns.validateSettings(cfgSettings);
	}
	...
	public void loadFromSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
		...
		m_appendColumns.loadSettingsFrom(cfgSettings);
	}
	...
	public void saveToSettings(final NodeSettingsWO settings) {
		...
		m_appendColumns.saveSettingsTo(cfgSettings);
	}
}
