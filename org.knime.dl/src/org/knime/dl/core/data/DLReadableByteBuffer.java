...
/**
 * A {@link DLReadableBuffer readable} byte buffer.
 *
 ...
 */
public interface DLReadableByteBuffer extends DLReadableShortBuffer {
     ...
     */
    byte readNextByte() throws BufferUnderflowException;
     ...
     * @throws BufferUnderflowException if the buffer's {@link #size() size} is exceeded.
     */
    void readToByteArray(byte[] dest, int destPos, int length);
}
