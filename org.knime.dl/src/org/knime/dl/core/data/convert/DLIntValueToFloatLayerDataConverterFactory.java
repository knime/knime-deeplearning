 ...
 */
public class DLIntValueToFloatLayerDataConverterFactory
		implements DLDataValueToLayerDataConverterFactory<IntValue, DLWritableFloatBuffer> {
	...
	@Override
	public DLDataValueToLayerDataConverter<IntValue, DLWritableFloatBuffer> createConverter() {
		return new DLDataValueToLayerDataConverter<IntValue, DLWritableFloatBuffer>() {
