 ...
 */
public final class DLLayerDataToListCellConverterFactory<I extends DLReadableBuffer, OE extends DataCell>
		implements DLLayerDataToDataCellConverterFactory<I, ListCell> {
	...
	public DLLayerDataToDataCellConverter<I, ListCell> createConverter() {
		...
		return new DLLayerDataToDataCellConverter<I, ListCell>() {

			@Override
			public void convert(final ExecutionContext exec, final DLLayerData<I> input, final Consumer<ListCell> out)
					throws Exception {
	...
	public boolean equals(final Object obj) {
		...
		final DLLayerDataToListCellConverterFactory other = (DLLayerDataToListCellConverterFactory) obj;
