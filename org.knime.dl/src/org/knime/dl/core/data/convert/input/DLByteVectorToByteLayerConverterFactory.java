...
public class DLByteVectorToByteLayerConverterFactory
		implements DLDataValueToLayerConverterFactory<ByteVectorValue, DLWritableShortBuffer> {
	...
	public DLDataValueToLayerDataConverter<ByteVectorValue, DLWritableShortBuffer> createConverter() {
		return new DLDataValueToLayerDataConverter<ByteVectorValue, DLWritableShortBuffer>() {
			...
			@Override
			public void convert(Iterable<ByteVectorValue> input, DLLayerData<DLWritableShortBuffer> output) {
				final DLWritableByteBuffer buf = output.getData();
				for (ByteVectorValue val : input) {
