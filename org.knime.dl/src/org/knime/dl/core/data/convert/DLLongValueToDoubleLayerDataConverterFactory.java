 ...
 */
public class DLLongValueToDoubleLayerDataConverterFactory
		implements DLDataValueToLayerDataConverterFactory<LongValue, DLWritableDoubleBuffer> {
	...
	@Override
	public DLDataValueToLayerDataConverter<LongValue, DLWritableDoubleBuffer> createConverter() {
		return new DLDataValueToLayerDataConverter<LongValue, DLWritableDoubleBuffer>() {
