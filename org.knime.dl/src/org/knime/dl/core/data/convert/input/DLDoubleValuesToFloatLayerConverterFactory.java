 ...
 */
public class DLDoubleValuesToFloatLayerConverterFactory
    implements DLDataValueToLayerConverterFactory<DoubleValue, DLWritableFloatBuffer> {

    @Override
    public String getName() {
        return "DoubleValue to FloatBuffer";
    }
