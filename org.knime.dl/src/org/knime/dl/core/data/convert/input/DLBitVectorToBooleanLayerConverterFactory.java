...
import org.knime.dl.core.data.writables.DLWritableBitBuffer;
 ...
 */
public class DLBitVectorToBooleanLayerConverterFactory
		implements DLDataValueToLayerConverterFactory<BitVectorValue, DLWritableBitBuffer> {

	@Override
	public String getName() {
		return "BitVector to Buffer";
	}
	...
	public DLDataValueToLayerDataConverter<BitVectorValue, DLWritableBitBuffer> createConverter() {
		return new DLDataValueToLayerDataConverter<BitVectorValue, DLWritableBitBuffer>() {
			...
			@Override
			public void convert(Iterable<BitVectorValue> input, DLLayerData<DLWritableBitBuffer> output) {
				final DLWritableBitBuffer buf = output.getData();
				for (BitVectorValue val : input) {
