...
/**
 * A {@link DLReadableBuffer readable} short buffer.
 *
 ...
 */
public interface DLReadableShortBuffer extends DLReadableFloatBuffer, DLReadableIntBuffer {
     ...
     */
    short readNextShort() throws BufferUnderflowException;
     ...
     * @throws BufferUnderflowException if the buffer's {@link #size() size} is exceeded.
     */
    void readToShortArray(short[] dest, int destPos, int length);
}
