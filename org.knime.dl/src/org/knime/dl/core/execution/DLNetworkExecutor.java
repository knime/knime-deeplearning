 ...
 */
public interface DLNetworkExecutor<N extends DLExecutableNetwork> extends DLBackendService, AutoCloseable {

    /**
     * Executes a {@link DLExecutableNetwork} given its input.
     *
     * @param network the {@link DLExecutableNetwork} to execute
     * @param inputs the network's populated inputs
     * @param outputs the network's outputs that will be populated
     * @throws RuntimeException if failed to execute the network
     */
    void execute(N network, Map<DLLayerDataSpec, DLLayerDataInput<?>> inputs,
        Map<DLLayerDataSpec, DLLayerDataOutput<?>> outputs) throws RuntimeException;
