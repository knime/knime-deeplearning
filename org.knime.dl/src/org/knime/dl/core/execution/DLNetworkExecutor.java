...
public interface DLNetworkExecutor<N extends DLExecutableNetwork> extends DLBackendService, AutoCloseable {
	 ...
	 * @param inputs
	 *            the network's populated inputs
	 * @param outputs
	 *            the network's outputs that will be populated
	 * @throws RuntimeException
	 *             if failed to execute the network
	 */
	void execute(N network, Map<DLLayerDataSpec, DLLayerData[]> inputs, Map<DLLayerDataSpec, DLLayerData[]> outputs,
			int batchSize) throws RuntimeException;
