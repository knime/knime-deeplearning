...
public abstract class DLAbstractNetworkExporter<N extends DLNetwork> implements DLNetworkExporter<N> {
    ...
    /**
     * Creates a new abstract network exporter.
     *
     * @param networkType the type of the deep learning networks
     * @param name the name of the exporter
     * @param validExtensions a list of valid extensions
     */
    public DLAbstractNetworkExporter(final Class<N> networkType, final String name, final String[] validExtensions) {
