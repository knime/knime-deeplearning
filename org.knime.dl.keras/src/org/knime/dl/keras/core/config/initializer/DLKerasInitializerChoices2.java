 ...
 */
public class DLKerasInitializerChoices2 extends DLKerasAbstractConfigObjectChoices<DLKerasInitializer> {


    /**
     * Second version of DLKerasInitializerChoices which uses double for all initializers.
     * (AP-9669 DL Keras: Node Generation Spinner Widget Bugs)
     */
    @SuppressWarnings("unchecked")
    public DLKerasInitializerChoices2() {
        super(new ParameterObjectChoice[]{new ParameterObjectChoice<>("Constant", DLKerasConstantInitializer2.class),
            ...
            new ParameterObjectChoice<>("Identity", DLKerasIdentityInitializer2.class),
            ...
            new ParameterObjectChoice<>("Orthogonal", DLKerasOrthogonalInitializer2.class),
            new ParameterObjectChoice<>("Random Normal", DLKerasRandomNormalInitializer2.class),
            new ParameterObjectChoice<>("Random Uniform", DLKerasRandomUniformInitializer2.class),
            new ParameterObjectChoice<>("Truncated Normal", DLKerasTruncatedNormalInitializer2.class),
            new ParameterObjectChoice<>("Variance Scaling", DLKerasVarianceScalingInitializer2.class),
