 ...
 */
public final class DLKerasL2Regularizer2 extends DLKerasAbstractConfigObject implements DLKerasRegularizer {
    ...
    /**
     */
    public DLKerasL2Regularizer2() {
        super("keras.regularizers.l2");
    }
    ...
    protected void populateParameters(List<String> positionalParams, Map<String, String> namedParams) {
        namedParams.put("l", DLPythonUtils.toPython(m_l2));
    }
