 ...
 */
abstract class DLKerasAbstractConstraint extends DLKerasAbstractConfigObject implements DLKerasConstraint {

    /**
     * @param kerasIdentifier
     */
    public DLKerasAbstractConstraint(String kerasIdentifier) {
