 ...
 */
public final class DLKerasL1L2Regularizer2 extends DLKerasAbstractConfigObject implements DLKerasRegularizer {

    @Parameter(label = "L1 regularization factor", min = "0.0000001", stepSize = "0.0000001")
    private double m_l1 = 0.0000001;

    @Parameter(label = "L2 regularization factor", min = "0.0000001", stepSize = "0.0000001")
    private double m_l2 = 0.0000001;

    /**
     */
    public DLKerasL1L2Regularizer2() {
        super("keras.regularizers.l1_l2");
    }
    ...
    protected void populateParameters(List<String> positionalParams, Map<String, String> namedParams) {
        ...
        namedParams.put("l2", DLPythonUtils.toPython(m_l2));
    }
