...
public class DLKerasLayerDataSpecTableCreatorFactory implements TableCreatorFactory {
	...
	public static class DLKerasLayerDataSpecTableCreator implements TableCreator<DLDefaultLayerDataSpec[]> {
		...
		private static boolean checkTableSpec(final TableSpec spec) {
			...
			return spec.getNumberColumns() == 4 && colNames[0].equals("name") && colNames[1].equals("batch_size")
					&& colNames[2].equals("shape") && colNames[3].equals("type") && colTypes[0].equals(Type.STRING)
					&& (colTypes[1].equals(Type.LONG) || colTypes[1].equals(Type.INTEGER)
							|| colTypes[1].equals(Type.STRING) /* TODO */)
					&& (colTypes[2].equals(Type.LONG_LIST) || colTypes[2].equals(Type.INTEGER_LIST))
		...
		public DLKerasLayerDataSpecTableCreator(final TableSpec spec, final int tableSize,
			...
			assert checkTableSpec(spec) : "Python side sent an invalid layer data specs table.";
