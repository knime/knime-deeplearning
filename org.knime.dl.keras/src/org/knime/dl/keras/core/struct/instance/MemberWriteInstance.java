 ...
 */
public interface MemberWriteInstance<T> extends MemberInstance<T> {

    /**
     * Set the object into the storage associated with this {@link MemberWriteInstance}.
     * 
     * @param obj to set.
     * @throws InvalidSettingsException in case obj can't be set.
     */
