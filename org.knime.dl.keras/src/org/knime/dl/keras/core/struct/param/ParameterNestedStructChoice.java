...
/**
 * {@link ParameterChoice} where choices are nested {@link Struct}s.
 * 
 * @author Christian Dietz, KNIME GmbH, Konstanz, Germany
 * 
 * @param <T> type of choice.
 */
public interface ParameterNestedStructChoice<T> extends ParameterChoice<T> {

    /**
     * @return {@link StructAccess} on objects of type <T>
     */
    StructAccess<MemberReadWriteAccess<?, T>> access();
