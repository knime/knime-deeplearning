 ...
 */
public class DefaultMemberReadWriteAccess<T, S> implements MemberReadWriteAccess<T, S> {
     ...
     * Constructor
     * 
     * @param member representing this access
     * @param access value read and write access
     */
    public <A extends ValueReadAccess<T, S> & ValueWriteAccess<T, S>> DefaultMemberReadWriteAccess(
        final Member<T> member, final A access) {
        m_member = member;
        m_readAccess = access;
    ...
    @Override
    public void set(S storage, Object obj) throws InvalidSettingsException {
