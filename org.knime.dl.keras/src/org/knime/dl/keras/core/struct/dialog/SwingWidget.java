 ...
 * @param <T> type which is configurable by the widget
 */
public interface SwingWidget<T> {

    /**
     * @param enabled if <code>true</code> all children of this widgets are active, otherwise inactive.
     */
    void setEnabled(boolean enabled);

    /**
     * @return {@link Member} associated with this {@link SwingWidget}.
     */
    Member<T> member();
     ...
     * 
     * @param instance the {@link MemberWriteInstance} to save the settings to.
     * @throws InvalidSettingsException in case something goes wrong during saving.
     */
    void saveTo(MemberWriteInstance<T> instance) throws InvalidSettingsException;
