 ...
 */
public interface NestedMemberWriteAccess<T, S> extends MemberWriteAccess<T, S> {
    StructInstance<? extends MemberWriteInstance<?>, ?> getWritableStructInstance(S storage, Class<T> type)
