 ...
 */
public class DLKerasBatchNormalizationLayer2 extends DLKerasAbstractUnaryLayer {
    ...
    @Parameter(label = "Beta initializer", choices = DLKerasInitializerChoices2.class, tab = "Advanced")
    private DLKerasInitializer m_betaInitializer = new DLKerasZerosInitializer();

    @Parameter(label = "Gamma initializer", choices = DLKerasInitializerChoices2.class, tab = "Advanced")
    private DLKerasInitializer m_gammaInitializer = new DLKerasOnesInitializer();

    @Parameter(label = "Moving mean initializer", choices = DLKerasInitializerChoices2.class, tab = "Advanced")
    private DLKerasInitializer m_movingMeanInitializer = new DLKerasZerosInitializer();

    @Parameter(label = "Moving variance initializer", choices = DLKerasInitializerChoices2.class, tab = "Advanced")
    ...
    @Parameter(label = "Beta constraint", required = Required.OptionalAndNotEnabled,
        choices = DLKerasConstraintChoices2.class, tab = "Advanced")
     ...
     * Constructor
     */
    public DLKerasBatchNormalizationLayer2() {
