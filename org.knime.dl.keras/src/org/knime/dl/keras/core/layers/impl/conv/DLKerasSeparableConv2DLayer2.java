 ...
 */
public final class DLKerasSeparableConv2DLayer2 extends DLKerasAbstractUnaryLayer {
    ...
    @Parameter(label = "Depthwise regularizer", required = Required.OptionalAndNotEnabled, choices = DLKerasRegularizerChoices2.class,
        tab = "Advanced")
    private DLKerasRegularizer m_depthwiseRegularizer = null;

    @Parameter(label = "Pointwise regularizer", required = Required.OptionalAndNotEnabled, choices = DLKerasRegularizerChoices2.class,
        tab = "Advanced")
    ...
    @Parameter(label = "Depthwise constraint", required = Required.OptionalAndNotEnabled, choices = DLKerasConstraintChoices2.class,
        tab = "Advanced")
    private DLKerasConstraint m_depthwiseConstraint = null;

    @Parameter(label = "Pointwise constraint", required = Required.OptionalAndNotEnabled, choices = DLKerasConstraintChoices2.class,
        tab = "Advanced")
     ...
     * Constructor
     */
    public DLKerasSeparableConv2DLayer2() {
        super("keras.layers.SeparableConv2D", DLLayerUtils.FLOATING_POINT_DTYPES);
    }
