...
/**
 * TODO Copy from org.knime.python2.util but I need multiple caches because I only have one UUID per layer but want to save two things per layer
 *
...
public class MemoryAlertAwareGuavaCache {
    ...
    private static final MemoryAlertAwareGuavaCache CACHE_SERIALIZED = new MemoryAlertAwareGuavaCache();
    
    private static final MemoryAlertAwareGuavaCache CACHE_OBJECTS = new MemoryAlertAwareGuavaCache();

    public static MemoryAlertAwareGuavaCache getInstanceSerialized() {
        return CACHE_SERIALIZED;
    }
    
    public static MemoryAlertAwareGuavaCache getInstanceObjects() {
    ...
    public <V> V get(final String key, final Callable<V> valueLoader) throws ExecutionException {
