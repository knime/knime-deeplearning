 ...
 */
public final class DLKerasThresholdedReLULayer extends DLKerasAbstractAdvancedActivationLayer {

    @Parameter(label = "Theta", stepSize="0.1")
    ...
    protected void populateParameters(List<String> positionalParams, Map<String, String> namedParams) {
        namedParams.put("theta", DLPythonUtils.toPython(m_theta));
    }
