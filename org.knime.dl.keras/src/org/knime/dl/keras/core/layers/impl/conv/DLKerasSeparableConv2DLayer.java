...
public final class DLKerasSeparableConv2DLayer extends DLKerasAbstractUnaryLayer {
    ...
    @Parameter(label = "Depthwise regularizer", required = Required.OptionalAndNotEnabled, choices = DLKerasRegularizerChoices.class,
        tab = "Advanced")
    private DLKerasRegularizer m_depthwiseRegularizer = null;

    @Parameter(label = "Pointwise regularizer", required = Required.OptionalAndNotEnabled, choices = DLKerasRegularizerChoices.class,
        tab = "Advanced")
    ...
    @Parameter(label = "Depthwise constraint", required = Required.OptionalAndNotEnabled, choices = DLKerasConstraintChoices.class,
        tab = "Advanced")
    private DLKerasConstraint m_depthwiseConstraint = null;

    @Parameter(label = "Pointwise constraint", required = Required.OptionalAndNotEnabled, choices = DLKerasConstraintChoices.class,
        tab = "Advanced")
