 ...
 */
public final class DLKerasConv3DLayer2 extends DLKerasAbstractUnaryLayer {

    @Parameter(label = "Filters", min = "1")
    private int m_filters = 1;

    @Parameter(label = "Kernel size")
    private DLKerasTuple m_kernelSize = new DLKerasTuple("1, 1, 1");
    ...
    private DLKerasTuple m_dilationRate = new DLKerasTuple("1, 1, 1");

    @Parameter(label = "Activation function")
    private DLKerasActivation m_activation = DLKerasActivation.LINEAR;

    @Parameter(label = "Kernel initializer", choices = DLKerasInitializerChoices2.class, tab = "Advanced")
    ...
    @Parameter(label = "Kernel regularizer", required = Required.OptionalAndNotEnabled, choices = DLKerasRegularizerChoices2.class, tab = "Advanced")
    ...
    @Parameter(label = "Kernel constraint", required = Required.OptionalAndNotEnabled, choices = DLKerasConstraintChoices2.class, tab = "Advanced")
