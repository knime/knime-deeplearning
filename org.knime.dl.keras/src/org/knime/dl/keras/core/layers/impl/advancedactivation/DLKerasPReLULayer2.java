 ...
 */
public final class DLKerasPReLULayer2 extends DLKerasAbstractAdvancedActivationLayer {

    @Parameter(label = "Alpha initializer", choices = DLKerasInitializerChoices2.class)
    private DLKerasInitializer m_alphaInitializer = new DLKerasZerosInitializer();

    @Parameter(label = "Alpha regularizer", required = Required.OptionalAndNotEnabled, choices = DLKerasRegularizerChoices2.class,
        tab = "Advanced")
    private DLKerasRegularizer m_alphaRegularizer = null;

    @Parameter(label = "Alpha constraint", required = Required.OptionalAndNotEnabled, choices = DLKerasConstraintChoices2.class, tab = "Advanced")
