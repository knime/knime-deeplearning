...
public final class DLKerasUpSampling2DLayer extends DLKerasAbstractUnaryLayer {
    ...
    public void validateParameters() throws InvalidSettingsException {
        DLConvolutionLayerUtils.validateTupleStrings(new String[]{m_size}, new String[]{"Size"}, 2);
    }
    ...
    protected Long[] inferOutputShape(final Long[] inputShape) {
        ...
        return DLConvolutionLayerUtils.computeUpSamplingOutputShape(inputShape, size, m_dataFormat.value());
    }
