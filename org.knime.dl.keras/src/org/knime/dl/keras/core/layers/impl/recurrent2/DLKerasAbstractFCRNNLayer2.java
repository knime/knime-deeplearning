 ...
 */
public abstract class DLKerasAbstractFCRNNLayer2 extends DLKerasAbstractRNNLayer2 {
    ...
    /**
     * Constructor for {@link DLKerasAbstractFCRNNLayer2}s.
     * 
     * @param kerasIdentifier the full python path to the layer constructor
     * @param numHiddenStates the number of hidden states
     */
    public DLKerasAbstractFCRNNLayer2(String kerasIdentifier, int numHiddenStates) {
