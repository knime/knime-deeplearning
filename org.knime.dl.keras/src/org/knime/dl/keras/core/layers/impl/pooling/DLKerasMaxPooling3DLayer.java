 ...
 */
public final class DLKerasMaxPooling3DLayer extends DLKerasAbstractUnaryLayer {
     ...
     * Constructor
     */
    public DLKerasMaxPooling3DLayer() {
        super("keras.layers.MaxPooling3D", DLLayerUtils.NUMERICAL_DTYPES);
    }
    ...
    protected Long[] inferOutputShape(final Long[] inputShape) {
        return DLConvolutionLayerUtils.computeOutputShape(inputShape, m_poolSize.getTuple(), m_strides.getTuple(),
            DLConvolutionLayerUtils.DEFAULT_3D_DILATION, m_padding.value(), getDataFormat().value());
    }
