...
public final class DLKerasTheanoCommands extends DLKerasAbstractCommands<DLKerasTheanoCommandsConfig> {
	...
	public DLKerasTheanoCommands() throws IOException {
		super(new DLKerasTheanoCommandsConfig());
	}

	public DLKerasTheanoCommands(final PythonKernel kernel) throws IOException {
		super(new DLKerasTheanoCommandsConfig(), kernel);
	}
