...
import org.knime.dl.keras.base.nodes.layers.DLKerasAbstractLayerNodeModel;
 ...
 */
class DLKerasCollectLayerNodeModel extends DLKerasAbstractLayerNodeModel<DLKerasCollectLayer> {

    /**
     */
    protected DLKerasCollectLayerNodeModel() {
        super(new PortType[]{DLKerasNetworkPortObjectBase.TYPE, DLKerasNetworkPortObjectBase.TYPE},
            new PortType[]{DLKerasNetworkPortObjectBase.TYPE}, DLKerasCollectLayer.class);
    }
    ...
    protected PortObjectSpec[] configure(PortObjectSpec[] inSpecs) throws InvalidSettingsException {
        ...
        // the collect layer doesn't need to validate anything
