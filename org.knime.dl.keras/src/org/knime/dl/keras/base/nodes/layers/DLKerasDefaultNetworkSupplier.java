 ...
 */
public class DLKerasDefaultNetworkSupplier extends DLKerasAbstractLayerNode implements DLKerasNetworkSupplier {

    public DLKerasDefaultNetworkSupplier(final DLKerasInputLayer inputLayer) {
        super(inputLayer);
    }
