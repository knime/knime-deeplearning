...
import org.knime.dl.keras.base.nodes.layers.DLKerasBinaryInnerLayerNodeFactory.DLKerasBinaryLayerNodeModel;
 ...
 */
public final class DLKerasBinaryInnerLayerNodeFactory extends NodeFactory<DLKerasBinaryLayerNodeModel> {

    private DLKerasBinaryLayer m_layer;

    public DLKerasBinaryInnerLayerNodeFactory(DLKerasBinaryLayer layer) {
        m_layer = layer;
    }

    @Override
    public DLKerasBinaryLayerNodeModel createNodeModel() {
        return new DLKerasBinaryLayerNodeModel(m_layer);
    }
    ...
    @Override
    public NodeView<DLKerasBinaryLayerNodeModel> createNodeView(int viewIndex, DLKerasBinaryLayerNodeModel nodeModel) {
        return null;
    }

    class DLKerasBinaryLayerNodeModel extends NodeModel {

        private DefaultNodeStructInstance<DLKerasBinaryLayer> m_instance;

        private DLKerasBinaryLayer m_layer;

        protected DLKerasBinaryLayerNodeModel(DLKerasBinaryLayer layer) {
        ...
        protected PortObjectSpec[] configure(PortObjectSpec[] inSpecs) throws InvalidSettingsException {
            ...
            DLKerasLayerNodeUtil.setLayerParent(m_layer, 1, (DLKerasNetworkPortObjectSpecBase)inSpecs[1]);
        ...
        protected PortObject[] execute(PortObject[] inObjects, ExecutionContext exec) throws Exception {
            ...
            DLKerasLayerNodeUtil.amendBaseNetworkSource(m_layer, 1, (DLKerasNetworkPortObjectBase)inObjects[1]);
