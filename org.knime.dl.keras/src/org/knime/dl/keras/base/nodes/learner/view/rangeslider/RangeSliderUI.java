...
/*
 * Original source code: Copyright © 2010 Ernest Yu. Released under MIT License.
 * This modified version of the source code: Copyright © 2017 by Ernest Yu and KNIME AG, Switzerland
*/

package org.knime.dl.keras.base.nodes.learner.view.rangeslider;
...
class RangeSliderUI extends BasicSliderUI {
    ...
    private Color rangeColor = Color.gray; //This line was modified. Original: private Color rangeColor = Color.GREEN;
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        g2d.setColor(Color.gray); //This line was modified. Original: g2d.setColor(Color.CYAN);
        g2d.fill(thumbShape);

        g2d.setColor(Color.gray); //This line was modified. Original: g2d.setColor(Color.BLUE);
        g2d.draw(thumbShape);
    ...
    private void paintUpperThumb(Graphics g) {
        ...
        g2d.setColor(Color.gray); //This line was modified. Original: g2d.setColor(Color.PINK);
        g2d.fill(thumbShape);

        g2d.setColor(Color.gray); //This line was modified. Original: g2d.setColor(Color.RED);
        g2d.draw(thumbShape);
