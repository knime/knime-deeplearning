 ...
 */
public final class DLKerasDenseLayerNodeFactory extends DLKerasAbstractNetworkFunctionNodeFactory {

    @Override
    protected PortToPortFunction<?, ?, ?, ?> createPortToPortFunction() {
        return new DLKerasDefaultNetworkFunction(new DLKerasDenseLayer());
    }
}
