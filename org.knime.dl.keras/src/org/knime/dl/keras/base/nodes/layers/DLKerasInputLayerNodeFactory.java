...
import org.knime.dl.keras.base.nodes.layers.DLKerasInputLayerNodeFactory.DLKerasInputLayerNodeModel;
 ...
 */
public final class DLKerasInputLayerNodeFactory extends NodeFactory<DLKerasInputLayerNodeModel> {

    private DLKerasInputLayer m_layer;

    public DLKerasInputLayerNodeFactory(DLKerasInputLayer layer) {
        m_layer = layer;
    }

    @Override
    public DLKerasInputLayerNodeModel createNodeModel() {
        return new DLKerasInputLayerNodeModel(m_layer);
    }
    ...
    @Override
    public NodeView<DLKerasInputLayerNodeModel> createNodeView(int viewIndex, DLKerasInputLayerNodeModel nodeModel) {
        return null;
    }
    ...
    class DLKerasInputLayerNodeModel extends NodeModel {

        private NodeStructInstance<DLKerasInputLayer> m_instance;

        private DLKerasInputLayer m_layer;

        protected DLKerasInputLayerNodeModel(DLKerasInputLayer layer) {
            super(new PortType[0], new PortType[]{DLKerasNetworkPortObjectBase.TYPE});
