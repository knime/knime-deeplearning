 ...
 */
public final class DLKerasDropoutLayerNodeFactory extends DLKerasAbstractNetworkFunctionNodeFactory {

    @Override
    protected PortToPortFunction<?, ?, ?, ?> createPortToPortFunction() {
        return new DLKerasDefaultNetworkFunction(new DLKerasDropoutLayer());
    }
}
