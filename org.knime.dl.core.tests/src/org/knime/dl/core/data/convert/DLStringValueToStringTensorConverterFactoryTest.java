...
import org.knime.dl.core.data.convert.DLStringValueToStringTensorConverterFactory;
...
public class DLStringValueToStringTensorConverterFactoryTest {
    ...
    public void testCreateConverter() throws Exception {
        ...
        try (DLDefaultStringBuffer buffer = new DLDefaultStringBuffer(10l);
                DLTensor<DLWritableStringBuffer> tensor =
                    new DLDefaultTensor<DLWritableStringBuffer>(spec, buffer, 10l)) {
            ...
            DLDataValueToTensorConverter<StringValue, DLWritableStringBuffer> converter =
                createFactory().createConverter();
