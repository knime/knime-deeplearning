...
public class DLDefaultShortBufferTest {

    @Test
    public void testPutBoolean() throws Exception {
        try (DLDefaultShortBuffer buffer = new DLDefaultShortBuffer(10)) {
    ...
    public void testPutBooleanOverflow() throws Exception {
        try (DLDefaultShortBuffer buffer = new DLDefaultShortBuffer(1)) {
            buffer.put(true);
            buffer.put(false);
        }
    }
    ...
    public void testPutAllBoolean() throws Exception {
        try (DLDefaultShortBuffer buffer = new DLDefaultShortBuffer(10)) {
            ...
            assertArrayEquals(toShort(expected), buffer.m_storage);
        }
    }
    ...
    public void testToShortArray() throws Exception {
        try (DLDefaultShortBuffer buffer = new DLDefaultShortBuffer(10)) {
            final short[] expected = shortRange(10);
            buffer.putAll(expected);
            assertArrayEquals(expected, buffer.toShortArray());
        }
    }
    ...
    public void testSetStorageWrongCapacity() throws Exception {
        try (DLDefaultShortBuffer buffer = new DLDefaultShortBuffer(10)) {
            final short[] storage = shortRange(11);
