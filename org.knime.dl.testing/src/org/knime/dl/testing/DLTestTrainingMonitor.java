 ...
 */
public final class DLTestTrainingMonitor<S extends DLTrainingStatus> extends DLTestAbstractSessionMonitor
		implements DLTrainingMonitor<S> {

	private final S m_trainingStatus;

	public DLTestTrainingMonitor(final S trainingStatus) {
		m_trainingStatus = trainingStatus;
	}
